...
namespace figurageometrica
{
    ...
    {
        // Se define un atributo privado para el segundo lado del triangulo
        private float lado2;
        ...
        // Constructor de la clase triangulo que toma dos lados como parámetros
        ...
        {
            // Retorna el área del triángulo, que es el producto de sus dos lados
            return Lado1 * Lado2;
        }
        ...
        {
            // Retorna el perímetro del triángulo, que es la suma de sus cuatro lados
